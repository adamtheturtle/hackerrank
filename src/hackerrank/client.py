...
from hackerrank._retries import request_with_retries
...
class EnvironmentsNamespace(_Namespace):
    ...
    def list(self) -> builtins.list[Environment]:
...
@beartype
class CandidatesNamespace(_Namespace):
    """Namespace for global candidate operations."""
